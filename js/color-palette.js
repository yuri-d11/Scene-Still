// JavaScript Document for Color Palette extraction
        document.addEventListener('DOMContentLoaded', () => {
            ...
            thumbnailGrid.addEventListener('click', (e) => {
                if (e.target && e.target.classList.contains('thumbnail-image')) {
                    ...
                    updateMainImageAndPalette(e.target.src, thumbnailWrapper);
                }
            });
            ...
            // --- Initial Load ---
            const firstThumbnailWrapper = thumbnailGrid.querySelector('.thumbnail-wrapper');
            const firstThumbnailImage = thumbnailGrid.querySelector('.thumbnail-image');
            if (firstThumbnailImage && firstThumbnailWrapper) {
                updateMainImageAndPalette(firstThumbnailImage.src, firstThumbnailWrapper);
            }
        });